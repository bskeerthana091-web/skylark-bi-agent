    ...
    <header className="sticky top-0 z-40 p-3 md:px-6">
      <div className="floating-window px-4 py-2.5 flex items-center justify-between shadow-2xl backdrop-blur-xl border border-gray-800/80">
        ...
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-brand-600 via-indigo-500 to-purple-500 flex items-center justify-center shadow-md shadow-brand-500/20 shrink-0">
            <Bot className="w-4 h-4 text-white" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-extrabold text-sm tracking-tight text-white whitespace-nowrap">Skylark BI Agent</h1>
              <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-brand-500/20 text-brand-300 border border-brand-500/30 whitespace-nowrap">
                FLOATING OS
              </span>
            </div>
            <p className="text-[11px] text-gray-400">Monday.com Business Intelligence Assistant</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gray-900/80 hover:bg-gray-800 border border-gray-800 transition-all text-xs"
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3.5 py-1.5 rounded-xl border text-xs font-semibold transition-all whitespace-nowrap ${
              config.apiToken
